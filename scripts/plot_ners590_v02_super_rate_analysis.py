...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path(__file__).resolve().parents[1] / "results" / "ners590_v02" / "super_rate_figures",
    ...
    save(fig, args.output_dir / "super_rate_positive_fraction_by_power.png")
    ...
    save(fig, args.output_dir / "super_rate_positive_median_by_power.png")
    ...
    save(fig, args.output_dir / "super_rate_nonzero_count_by_local_case.png")
    ...
    save(fig, args.output_dir / "super_rate_sum_by_local_case.png")
    ...
    save(fig, args.output_dir / "top_super_rate_reactions_by_mean.png")
    ...
    ax.set_ylabel("Reaction")
    save(fig, args.output_dir / "top_super_rate_power_sensitive_reactions.png")
    ...
    ax.set_ylabel("Reaction")
    save(fig, args.output_dir / "super_rate_rate_const_correlation_top.png")
    ...
    save(fig, args.output_dir / "super_rate_case_sum_vs_power.png")
