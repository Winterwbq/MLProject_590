...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run curated separate-task SUPER RATE training experiments on NERS590 data."
    )
    parser.add_argument(
        "--raw-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Root directory for SUPER RATE training results.",
    )
    parser.add_argument(
    ...
    random_report = (
        ...
        / "archive"
        / "generated_reports"
        / "ners590_super_rate_training_random_case_report.md"
    )
    ...
    power_holdout_report = (
        ...
        / "archive"
        / "generated_reports"
        / f"ners590_super_rate_training_power_holdout_{holdout_suffix}_report.md"
    )
    split_start = time.perf_counter()
    print(
