...
The main goal is to compare the targets jointly and separately, explain which models worked best, and interpret why the winning model choices differ between the two outputs. Citations: [experiment_summary.csv](../../../results/ners590_v02_joint_review/experiment_summary.csv), [ners590_v02_experiment_review.md](/Users/bingqingwang/Desktop/UMich/590_Machine%20learning/project/docs/archive/active_v02/ners590_v02_experiment_review.md), [ners590_v02_super_rate_training_review.md](/Users/bingqingwang/Desktop/UMich/590_Machine%20learning/project/docs/v03/ideas/3_super_rate_training_lessons_from_v02.md).
